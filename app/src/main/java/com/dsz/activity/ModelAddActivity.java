 ...
 */
public class ModelAddActivity extends FragmentActivity implements View.OnClickListener {
...
//        addNameSql = new AddNameSql(ModelAddActivity.this);
//        addNameSql.open();
...
//        addArray = new ArrayAdapter<AddNameBean>(this, android.R.layout.simple_list_item_1, listBean);
        ...
        modelAddDB = new ModelAddDB(ModelAddActivity.this);
...
//                Log.d("haocan","haocan");
                finish();
//                Intent intent = new Intent(ModelAddActivity.this,ModelActivity.class);
